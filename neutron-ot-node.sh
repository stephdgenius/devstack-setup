...
sudo cp /media/usb/config/neutron/neutron-nt.conf /etc/neutron/neutron.conf
sudo cp /media/usb/config/neutron/ml2_conf.ini /etc/neutron/plugins/ml2/ml2_conf.ini
sudo cp /media/usb/config/neutron/linuxbridge_agent-ot.ini /etc/neutron/plugins/ml2/linuxbridge_agent.ini
